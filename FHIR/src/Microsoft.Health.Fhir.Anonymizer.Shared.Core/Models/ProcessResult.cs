...
namespace Microsoft.Health.Fhir.Anonymizer.Core.Models
{
    public class ProcessResult
    {
        ...
        /// <summary>
        /// Records a privacy-related metric for audit and reporting purposes.
        /// </summary>
        public void AddPrivacyMetric(string key, object value)
        {
            // Privacy metrics are recorded for audit/reporting; current implementation is a no-op stub.
        }
    }
}
