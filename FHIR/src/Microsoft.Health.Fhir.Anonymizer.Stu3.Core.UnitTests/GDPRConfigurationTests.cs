...
namespace Microsoft.Health.Fhir.Anonymizer.Core.UnitTests
{
    ...
    {
        private const string GdprConfigPath = "../Microsoft.Health.Fhir.Anonymizer.Stu3.CommandLineTool/configuration-gdpr-article89.json";
        ...
        public void GivenGDPRConfiguration_WhenLoaded_ShouldHaveCorrectFhirVersion()
        {
            ...
            // Assert
            Assert.Equal("Stu3", configurationManager.Configuration.fhirVersion);
        }
        ...
        public void GivenGDPRConfiguration_WhenLoaded_ShouldHaveGeneticDataRedactionRules()
        {
            ...
            // Assert - Verify genetic data redaction rules exist (Sequence in STU3)
            Assert.Contains(rules, r => r.ResourceType == "Sequence");
        }
